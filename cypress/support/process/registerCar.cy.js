...
When('I fill all inputs with valid data', () => {
  ...
  vehicleDataPage.fillValidVehicleData();
  productDataPage.fillValidProductData();
  priceOptionPage.fillValidInsurancePriceOption();
  sendQuotePage.fillValidSendQuote();
});

Then('I validate that the registration was successful', () => {
  sendQuotePage.validateCarRegistration();
});
